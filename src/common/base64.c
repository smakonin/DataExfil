...
int base64_encode_alloc(const char *in, int inlen, char **out)
{
...
bool base64_decode(const char *in, int inlen, char *out, int *outlen)
{
  int outleft = *outlen;
...
/* Allocate an output buffer in *OUT, and decode the base64 encoded
   ...
   *OUT and *OUTLEN parameters to differentiate between successful
   ...
   undefined. */
bool base64_decode_alloc(const char *in, int inlen, char **out, int *outlen)
{
